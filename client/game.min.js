...
SnookerContract.errored()&&SnookerContract.clearError();if(null==(c=a.hudPoint)||!c.isDown){k.jumpTo(0);break}d={x:a.hudPoint.x/a.ratio.x,y:a.hudPoint.y/a.ratio.y};a.hudPoint=null;if(D(d,a.githubBtn)&&a.githubBtn.isDown){window.open("","_blank");k.jumpTo(3);break}if(D(d,a.litemintBtn)&&a.litemintBtn.isDown){window.open("https://litemint.com","_blank");k.jumpTo(3);break}if(a.stageScreen===a.StageScreen.Score){D(d,a.closeBtn)&&(a.stageScreen=a.StageScreen.Intro);
